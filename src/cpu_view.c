...
void cpu_view_render(gb_system_t *gb)
{
    ...
    render_text(cpu_view_font, cpu_view_ren, coll, line_height * 2, "A: $%02X", reg_readb(REG_A, gb));
    render_text(cpu_view_font, cpu_view_ren, colr, line_height * 2, "F: $%02X", reg_readb(REG_F, gb));
    render_text(cpu_view_font, cpu_view_ren, coll, line_height * 3, "B: $%02X", reg_readb(REG_B, gb));
    render_text(cpu_view_font, cpu_view_ren, colr, line_height * 3, "C: $%02X", reg_readb(REG_C, gb));
    render_text(cpu_view_font, cpu_view_ren, coll, line_height * 4, "D: $%02X", reg_readb(REG_D, gb));
    render_text(cpu_view_font, cpu_view_ren, colr, line_height * 4, "E: $%02X", reg_readb(REG_E, gb));
    render_text(cpu_view_font, cpu_view_ren, coll, line_height * 5, "H: $%02X", reg_readb(REG_H, gb));
    render_text(cpu_view_font, cpu_view_ren, colr, line_height * 5, "L: $%02X", reg_readb(REG_L, gb));
    render_text(cpu_view_font, cpu_view_ren, coll,          line_height * 6, "Z: %i", reg_flag(FLAG_Z, gb));
    render_text(cpu_view_font, cpu_view_ren, coll + w4,     line_height * 6, "H: %i", reg_flag(FLAG_H, gb));
    render_text(cpu_view_font, cpu_view_ren, coll + w4 * 2, line_height * 6, "N: %i", reg_flag(FLAG_N, gb));
    render_text(cpu_view_font, cpu_view_ren, coll + w4 * 3, line_height * 6, "C: %i", reg_flag(FLAG_C, gb));
